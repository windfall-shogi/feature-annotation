...
from ..ki import BlackKiDropLayer

__author__ = 'Yasuhiro'
__date__ = '2018/3/13'


class TestBlackKiDrop(tf.test.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_ki_drop(self):
        ...
        drop_square = BlackKiDropLayer()(board, ph)
        # アクセスしやすいように次元を下げる
