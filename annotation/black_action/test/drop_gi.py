...
from ..gi import BlackGiDropLayer

__author__ = 'Yasuhiro'
__date__ = '2018/3/13'


class TestBlackGiDrop(tf.test.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_gi_drop(self):
        ...
        drop_square = BlackGiDropLayer()(board, ph)
        # アクセスしやすいように次元を下げる
