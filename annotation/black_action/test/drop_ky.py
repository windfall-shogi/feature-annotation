...
from ..ky import BlackKyDropLayer

__author__ = 'Yasuhiro'
__date__ = '2018/3/11'


class TestBlackKyDrop(tf.test.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_ky_drop(self):
        ...
        drop_square = BlackKyDropLayer(data_format=self.data_format)(board, ph)
        # アクセスしやすいように次元を下げる
