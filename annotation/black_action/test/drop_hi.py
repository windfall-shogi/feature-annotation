...
from ..hi import BlackHiDropLayer

__author__ = 'Yasuhiro'
__date__ = '2018/3/14'


class TestBlackHiDrop(tf.test.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_hi_drop(self):
        ...
        drop_square = BlackHiDropLayer()(board, ph)
        # アクセスしやすいように次元を下げる
